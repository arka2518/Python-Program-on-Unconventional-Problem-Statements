Genre = ('Science-fiction', 'Horror', 'Superhero', 'Action', 'Adventure', 'Crime-Thriller', 'Comedy', 'Drama', 'Romance', 'Rom-Com', 'Psycological-Thriller')
...
Preference = {"Science-friction" : ['Satish', 'Arka', 'Spondan', 'Swaroop'],
              "Horror" : ['Lakshya', 'Arka'],
              "Rom-Com" : ['Reetul', 'Mahi'],
